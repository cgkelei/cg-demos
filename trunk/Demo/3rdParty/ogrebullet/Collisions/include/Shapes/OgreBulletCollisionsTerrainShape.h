...
namespace OgreBulletCollisions
{
	...
	public:
		...
		void getMinMax(Ogre::Vector3& min, Ogre::Vector3& max)
		{
			btVector3 btMin, btMax;
			mShape->getAabb(btTransform::getIdentity(), btMin, btMax);
			min = Ogre::Vector3(btMin.x(), btMin.y(), btMin.z());
			max = Ogre::Vector3(btMax.x(), btMax.y(), btMax.z());
		}
