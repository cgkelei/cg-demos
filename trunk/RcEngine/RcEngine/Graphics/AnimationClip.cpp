...
AnimationClip::AnimationClip(uint32_t resType, ResourceManager* creator, ResourceHandle handle, const String& name, const String& group )
...
{
	return std::make_shared<AnimationClip>(ResourceTypes::Animation, creator, handle, name, group);
}
