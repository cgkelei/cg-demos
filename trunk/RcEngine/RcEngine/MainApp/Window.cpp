...
static void InitVKMapping()
{
	...
	VKMapping[VK_F3] = KC_F2;
	VKMapping[VK_F4] = KC_F3;
	VKMapping[VK_F5] = KC_F4;
	VKMapping[VK_F6] = KC_F5;
	VKMapping[VK_F7] = KC_F6;
	VKMapping[VK_F8] = KC_F7;
	VKMapping[VK_F9] = KC_F8;
	VKMapping[VK_F10] = KC_F9;
	VKMapping[VK_F11] = KC_F9;
	VKMapping[VK_F12] = KC_F9;
...
LRESULT Window::WndProc( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
	...
	case WM_LBUTTONDOWN:
		{
			MouseButtonsMask |= InputEventType::LeftButtonMask;
	...
	case WM_RBUTTONDOWN:
		{
			MouseButtonsMask |= InputEventType::RightButtonMask;
	...
	case WM_MBUTTONDOWN:
		{
			MouseButtonsMask |= InputEventType::MiddleButtonMask;
	...
	case WM_MOUSEMOVE:
		{
			...
			e.MouseMove.buttons = MouseButtonsMask;
