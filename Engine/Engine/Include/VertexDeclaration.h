...
namespace Engine
{
	...
	public:
		...
		/// </remark>
		/// </summary>
		virtual const VertexElement& AddElement(uint16 source, uint32 offset, VertexElementFormat theType,
		...
		/// </remark>
		/// </summary>
		virtual const VertexElement& InsertElement(uint32 atPosition, uint16 source, uint32 offset, VertexElementFormat theType,
			VertexElementUsage semantic, uint16 index = 0);
