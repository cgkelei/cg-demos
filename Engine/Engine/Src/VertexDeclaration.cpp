...
namespace Engine
{
	...
	const VertexElement* Engine::VertexDeclaration::FindElementBySemantic( VertexElementUsage sem, uint16 index /*= 0*/ )
	{
	...
	const VertexElement& VertexDeclaration::AddElement( uint16 source, uint32 offset, VertexElementFormat theType, VertexElementUsage semantic, uint16 index /*= 0*/ )
	{
	...
	const VertexElement& VertexDeclaration::InsertElement( uint32 atPosition, uint16 source, uint32 offset, VertexElementFormat theType, VertexElementUsage semantic, uint16 index /*= 0*/ )
	{
